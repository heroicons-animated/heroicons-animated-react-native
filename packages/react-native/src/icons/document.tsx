...
export type DocumentIconHandle = IconHandle;

const DocumentIcon = forwardRef<DocumentIconHandle, IconProps>(
  ({ size = 28, color = "currentColor", strokeWidth = 1.5, style, controlled, onPress }, ref) => {
    const translateY = useSharedValue(0);

    const startAnimation = useCallback(() => {
      translateY.value = withSequence(withTiming(0, { duration: 100 }), withTiming(-2, { duration: 100 }), withTiming(0, { duration: 100 }));
    }, [translateY]);
