...
export type ArrowLongLeftIconHandle = IconHandle;

const ArrowLongLeftIcon = forwardRef<ArrowLongLeftIconHandle, IconProps>(
        ...
        <Animated.View style={style}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            <AnimatedG animatedProps={p0Props}>
              <Path d="M6.75 15.75 3 12m0 0 3.75-3.75" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
            </AnimatedG>
