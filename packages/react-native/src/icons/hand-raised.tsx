...
export type HandRaisedIconHandle = IconHandle;

const HandRaisedIcon = forwardRef<HandRaisedIconHandle, IconProps>(
  ({ size = 28, color = "currentColor", strokeWidth = 1.5, style, controlled, onPress }, ref) => {
    const rotate = useSharedValue(0);

    const startAnimation = useCallback(() => {
      rotate.value = withSequence(withTiming(0, { duration: 160 }), withTiming(-15, { duration: 160 }), withTiming(10, { duration: 160 }), withTiming(-5, { duration: 160 }), withTiming(0, { duration: 160 }));
    }, [rotate]);
