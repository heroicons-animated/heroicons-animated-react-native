...
export type PhoneArrowUpRightIconHandle = IconHandle;

const PhoneArrowUpRightIcon = forwardRef<PhoneArrowUpRightIconHandle, IconProps>(
      ...
      >
        <Animated.View style={[animatedStyle, style]}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <Path d="M20.25 3.75v4.5m0-4.5h-4.5m4.5 0-6 6" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
          </Svg>
        </Animated.View>
      </IconWrapper>
    );
