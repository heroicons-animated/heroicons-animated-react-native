...
export type HandThumbDownIconHandle = IconHandle;

const HandThumbDownIcon = forwardRef<HandThumbDownIconHandle, IconProps>(
  ({ size = 28, color = "currentColor", strokeWidth = 1.5, style, controlled, onPress }, ref) => {
    const rotate = useSharedValue(0);

    const startAnimation = useCallback(() => {
      rotate.value = withSequence(withTiming(0, { duration: 150 }), withTiming(10, { duration: 150 }), withTiming(-5, { duration: 150 }), withTiming(0, { duration: 150 }));
    }, [rotate]);
