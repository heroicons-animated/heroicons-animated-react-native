...
export type DocumentArrowUpIconHandle = IconHandle;

const DocumentArrowUpIcon = forwardRef<DocumentArrowUpIconHandle, IconProps>(
      ...
      >
        <Animated.View style={[animatedStyle, style]}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <Path d="M15 14.25L12 11.25M12 11.25L9 14.25M12 11.25L12 17.25" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
          </Svg>
        </Animated.View>
      </IconWrapper>
    );
