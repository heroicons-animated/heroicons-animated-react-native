...
export type Battery50IconHandle = IconHandle;

const Battery50Icon = forwardRef<Battery50IconHandle, IconProps>(
      ...
      >
        <Animated.View style={[animatedStyle, style]}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <Path d="M4.5 10.5h6.75V15H4.5v-4.5Z" fill={color} fillRule="evenodd" clipRule="evenodd" />
            <Path d="M4.5 10.5h6.75V15H4.5v-4.5Z" fill={color} fillRule="evenodd" clipRule="evenodd" />
          </Svg>
        </Animated.View>
      </IconWrapper>
