...
export type ArrowUpOnSquareIconHandle = IconHandle;

const ArrowUpOnSquareIcon = forwardRef<ArrowUpOnSquareIconHandle, IconProps>(
      ...
      >
        <Animated.View style={[animatedStyle, style]}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <Path d="M15 5.25l-3-3m0 0-3 3m3-3V15" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
          </Svg>
        </Animated.View>
      </IconWrapper>
    );
