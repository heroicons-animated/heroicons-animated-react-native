...
export type ArrowDownIconHandle = IconHandle;

const ArrowDownIcon = forwardRef<ArrowDownIconHandle, IconProps>(
        ...
        <Animated.View style={style}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            <AnimatedG animatedProps={p0Props}>
              <Path d="M19.5 13.5 12 21m0 0-7.5-7.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
            </AnimatedG>
