...
export type FolderMinusIconHandle = IconHandle;

const FolderMinusIcon = forwardRef<FolderMinusIconHandle, IconProps>(
      ...
      >
        <Animated.View style={[animatedStyle, style]}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <Path d="M15 13.5H9" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
          </Svg>
        </Animated.View>
      </IconWrapper>
    );
