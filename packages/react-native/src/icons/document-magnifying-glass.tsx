...
const DocumentMagnifyingGlassIcon = forwardRef<DocumentMagnifyingGlassIconHandle, IconProps>(
  ({ size = 28, color = "currentColor", strokeWidth = 1.5, style, controlled, onPress }, ref) => {
    ...
    const startAnimation = useCallback(() => {
      translateX.value = withSequence(withTiming(0, { duration: 250 }), withTiming(0, { duration: 250 }), withTiming(-2, { duration: 250 }), withTiming(0, { duration: 250 }));
      translateY.value = withSequence(withTiming(0, { duration: 250 }), withTiming(-3, { duration: 250 }), withTiming(0, { duration: 250 }), withTiming(0, { duration: 250 }));
      ...
      >
        <Animated.View style={[animatedStyle, style]}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <Path d="M13.4812 15.7312L15 17.25M14.25 13.875C14.25 15.3247 13.0747 16.5 11.625 16.5C10.1753 16.5 9 15.3247 9 13.875C9 12.4253 10.1753 11.25 11.625 11.25C13.0747 11.25 14.25 12.4253 14.25 13.875Z" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
          </Svg>
        </Animated.View>
      </IconWrapper>
    );
