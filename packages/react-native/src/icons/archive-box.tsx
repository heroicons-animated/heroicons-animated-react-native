...
export type ArchiveBoxIconHandle = IconHandle;

const ArchiveBoxIcon = forwardRef<ArchiveBoxIconHandle, IconProps>(
  ({ size = 28, color = "currentColor", strokeWidth = 1.5, style, controlled, onPress }, ref) => {
    ...
    const startAnimation = useCallback(() => {
      ...
      p3TranslateY.value = withSpring(1, { stiffness: 200, damping: 25 });
      p4TranslateY.value = withSpring(-1.5, { stiffness: 200, damping: 25 });
    }, [p0TranslateY, p1TranslateY, p2TranslateY, p3TranslateY, p4TranslateY]);
        ...
        <Animated.View style={style}>
          <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <AnimatedG animatedProps={p3Props}>
              <Path d="M9.99976 11.25H13.9998" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
            </AnimatedG>
