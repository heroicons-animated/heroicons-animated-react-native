...
export type ServerStackIconHandle = IconHandle;

const ServerStackIcon = forwardRef<ServerStackIconHandle, IconProps>(
  ({ size = 28, color = "currentColor", strokeWidth = 1.5, style, controlled, onPress }, ref) => {
    const scaleY = useSharedValue(1);

    const startAnimation = useCallback(() => {
      scaleY.value = withSequence(withTiming(1, { duration: 133 }), withTiming(1.1, { duration: 133 }), withTiming(1, { duration: 133 }));
    }, [scaleY]);
