...
const BriefcaseIcon = forwardRef<BriefcaseIconHandle, IconProps>(
  ({ size = 28, color = "currentColor", strokeWidth = 1.5, style, controlled, onPress }, ref) => {
    ...
    const startAnimation = useCallback(() => {
      translateY.value = withSequence(withTiming(0, { duration: 133 }), withTiming(-3, { duration: 133 }), withTiming(0, { duration: 133 }));
    }, [translateY]);
